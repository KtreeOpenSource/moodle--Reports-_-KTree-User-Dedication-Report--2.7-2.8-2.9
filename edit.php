...
require_once($CFG->dirroot.'/report/ktreeuserdedicationreport/form.php');
require_login();
...
echo $OUTPUT->header();
$PAGE->set_heading($title);
$editform = new report_modulesection_form();
$data = $editform->get_data();
if (!empty($_POST['title'])&&!empty($_POST['description'])) {
    modulesection_add_instance();
    redirect(new moodle_url('/report/ktreeuserdedicationreport/adminreport.php'));
}
$editform->display();
echo $OUTPUT->footer();
